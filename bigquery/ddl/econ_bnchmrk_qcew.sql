...
(
  year_num                    INT64    NOT NULL,  -- reference year (e.g., 2022)
  naics2_sector_cd            STRING   NOT NULL,  -- 2-digit NAICS sector
  state_cnty_fips_cd          STRING   NOT NULL,  -- 5-digit county FIPS
  state_fips_cd               STRING   NOT NULL,  -- 2-digit state FIPS
  cnty_fips_cd                STRING   NOT NULL,  -- 3-digit county FIPS
